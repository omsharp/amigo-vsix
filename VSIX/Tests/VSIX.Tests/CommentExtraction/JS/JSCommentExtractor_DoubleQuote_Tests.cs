...
{
   public class JSCommentExtractor_DoubleQuote_Tests : JSCommentExtractor_Tests_Base
   {
      [Fact(DisplayName = "Comment after a single line string")]
      public void Comment_AfterStandardStringLiteral_DoubleQuote()
      {
         var codeLines = new[]
         {
            "var s = \"string\"",
      ...
      public void NoComment_InsideStandardStringLiteral_DoubleQuote()
      {
         var codeLines = new[]
         {
            "double d = 234.3",
      ...
      public void Comment_AfterEmptyStringLiteral_DoubleQuote()
      {
         var codeLines = new[]
         {
            "var s = \"string\"",
      ...
      public void HandleEscapedQuote_DoubleQuote()
      {
         var codeLines = new[]
         {
            "var s = \"string\"",
      ...
      [Fact(DisplayName = "Comment after concatenation of (\") strings")]
      public void Comment_AfterConcat_DoubleQuote()
      {
